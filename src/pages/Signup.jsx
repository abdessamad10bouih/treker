        ...
        <section className='w-full flex flex-col items-center'>
            ...
            <main className='w-full flex lg:h-[80vh] relative items-center flex-col justify-center'>
                ...
                <form className='w-full lg:w-[30%] gap-4 mt-6 px-5 flex flex-col items-center justify-center' action="">
                    ...
                    <div className='w-full h-20 flex flex-col gap-1 justify-center'>
                        <label htmlFor="nom" className='text-gray-400 text-sm'>Nom et Prénom</label>
                        <input type="text" id='nom' className='w-full h-12 border-2 px-3 outline-none text-primary border-primary rounded' placeholder='Entrez votre nom complet' />
                    </div>
                    <div className='w-full h-20 flex flex-col gap-1 justify-center'>
                    ...
                    <button className='w-full h-12 bg-secondary text-white rounded-full'>Crée Un compte</button>
                </form>
                <h1 className='text-sm mt-4 text-primary'>Vous avez déjà un compte ? <Link to="/connexion" className='text-secondary'>Connectez-vous</Link></h1>
