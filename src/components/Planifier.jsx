...
function Planifier() {
    return (
        <div className='w-full flex flex-col lg:flex-row justify-center items-center'>
            ...
            <div className='w-full lg:w-[40%] gap-5 h-full p-2 lg:p-7 flex flex-col items-center justify-start'>
                <h1 className='text-4xl text-center lg:text-start w-full text-primary font-semibold'>
                    Planifiez des <br /> voyages écolos <br /> facilement
                </h1>
                <p className='text-primary font-light text-center lg:text-start'>
                ...
                <div className='w-full gap-3 flex flex-col'>
                    <div className='w-full flex items-center gap-3 lg:gap-10 justify-center'>
                        <div className='w-full lg:w-[400px] h-[200px] gap-2 border rounded-xl flex items-center justify-center flex-col'>
                            <h1 className='text-5xl lg:text-6xl text-secondary font-semibold'>
