...
function Footer() {
    return (
        <footer className='w-full h-[60vh] flex flex-col border-t border-gray-200'>
            <div className='w-full h-[85%] flex'>
                ...
                <div className='w-[50%] h-full flex'>
                    <div className='w-[50%] gap-5 p-10 h-full flex flex-col justify-center'>
                    ...
                    <div className='w-[50%] gap-5 p-10 h-[75%] flex flex-col justify-center'>
            ...
            <div className='w-full h-[15%] px-14 border-t border-gray-200 flex items-center justify-between'>
                <h1 className='text-primary'>Copyright © 2024</h1>
                <h1 className='text-primary'>Tous droits réservés <span className='text-secondary'>| Conditions générales | Politique de confidentialité</span></h1>
            </div>
